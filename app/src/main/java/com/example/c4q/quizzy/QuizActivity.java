...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initializeQuestions() {
        questionBank = new Question[]{
                ...
                new Question(R.string.question_Rusi, true),
                new Question(R.string.fragment, false)
        };
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.cheat_button:
                ...
                //question is object cannot be passed in to putExtra needs to be primitive
//                Question currentQuestion = questionBank[currentIndex];
